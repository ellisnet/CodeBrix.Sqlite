...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Sqlite.ApacheLicenseForever - a SQLite convenience library over
      Microsoft.Data.Sqlite: selective encryption, EncryptedTable<T> with
      searchable and blind-indexed data, a Dapper-style mapper, and safe
